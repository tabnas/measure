...
assert.match(elements.get('#history-context').textContent, /^2 hosts · 3 series · 3 points$/)
...
assert.equal(elements.get('#history-context').textContent, '1 host · 1 series · 1 point')
assert.match(elements.get('#history-legend').innerHTML, /Lab B \(lab-b\)/)
