...
// read ONE file list (scripts/gated-docs.mjs) and ONE banned list
...
import { gatedDocs, tutorials } from './gated-docs.mjs'
...
describe('docs-style', () => {
  ...
  test('the-style-guide-names-both-gates', () => {
    ...
    for (const name of [
      'scripts/docs.test.mjs', 'scripts/gated-docs.mjs',
      '.vale.ini', 'reject.txt',
    ]) {
    ...
    // running it runs Vale, and an emptied recipe still has the name.
